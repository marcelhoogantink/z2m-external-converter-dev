...
const tzLocal = {
    diyruz_freepad_on_off_config: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const switchType = Object.hasOwn(switchTypesLookup, value) ? switchTypesLookup[value] : intVal;
            const switchActions = Object.hasOwn(switchActionsLookup, value) ? switchActionsLookup[value] : intVal;
