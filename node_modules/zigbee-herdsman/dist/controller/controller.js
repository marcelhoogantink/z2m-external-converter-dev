...
class Controller extends node_events_1.default.EventEmitter {
    ...
    async start() {
        ...
        if (model_1.Device.byType('Coordinator').length === 0) {
            ...
            const coordinator = model_1.Device.create('Coordinator', coordinatorIEEE, ZSpec.COORDINATOR_ADDRESS, this.adapter.manufacturerID, undefined, undefined, undefined, true, undefined);
    ...
    async onDeviceJoinedGreenPower(payload) {
        ...
        if (!device) {
            ...
            device = model_1.Device.create('GreenPower', ieeeAddr, payload.networkAddress, undefined, undefined, undefined, modelID, true, payload.securityKey ? Array.from(payload.securityKey) : /* v8 ignore next */ undefined);
            device.save();
    ...
    async onDeviceLeaveGreenPower(sourceID) {
    ...
    async onDeviceJoined(payload) {
        ...
        if (!device) {
            ...
            device = model_1.Device.create('Unknown', payload.ieeeAddr, payload.networkAddress, undefined, undefined, undefined, undefined, false, undefined);
            this.selfAndDeviceEmit(device, 'deviceJoined', { device });
        }
        else if (device.isDeleted) {
